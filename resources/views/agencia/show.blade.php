                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <p>{{ $ver->no_caat }}</p>
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">No. CAAT Aereo:</h5>
                                    <p>{{ $ver->no_caat_aereo }}</p>
                                    ...
                                    <p>{{ $ver->estado }}</p>
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">Ciudad:</h5>
                                    <p>{{ $ver->ciudad }}</p>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">Forma de Pago:</h5>
                                    <p>{{ $ver->forma_pago }}</p>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">Tarifa (uso exclusivo Aereo):</h5>
                                    <p>{{ $ver->uso_exclusivo_tarifa }}</p>
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">Referencia Bancaria (uso exclusivo Aereo):</h5>
                                    <p>{{ $ver->uso_exclusivo_referencia }}</p>
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">ID Promotora (uso exclusivo Aereo):</h5>
                                    <p>{{ $ver->uso_exclusivo_id }}</p>
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">Tarifa (uso exclusivo Marítimo):</h5>
                                    <p>{{ $ver->uso_exclusivo_tarifa_maritimo }}</p>
                                    <h5 class="title mt-3" style="font-size: 1.2rem; font-weight: bold;">Referencia Bancaria (uso exclusivo Marítimo):</h5>
                                    <p>{{ $ver->uso_exclusivo_referencia_maritimo }}</p>
