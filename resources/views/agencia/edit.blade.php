                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_caat_aereo" id="no_caat_aereo" class="form-control" value="{{ $ver->no_caat_aereo }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="uso_cfdi" id="uso_cfdi" class="form-control">
                                    <option value="G01: Adquisición de mercancías" {{ isset($ver->uso_cfdi) && $ver->uso_cfdi === 'G01: Adquisición de mercancías' ? 'selected' : '' }}>G01: Adquisición de mercancías</option>
                                    <option value="G02: Devoluciones o bonificaciones" {{ isset($ver->uso_cfdi) && $ver->uso_cfdi === 'G02: Devoluciones o bonificaciones' ? 'selected' : '' }}>G02: Devoluciones o bonificaciones</option>
                                    <option value="G03: Gastos en general" {{ isset($ver->uso_cfdi) && $ver->uso_cfdi === 'G03: Gastos en general' ? 'selected' : '' }}>G03: Gastos en general</option>
                                    <option value="O01: Construcciones" {{ isset($ver->uso_cfdi) && $ver->uso_cfdi === 'O01: Construcciones' ? 'selected' : '' }}>O01: Construcciones</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="tipo_alta" id="tipo_alta" class="form-control" value="{{ $ver->tipo_alta }}">
                                    ...
                                    <option value="Maritimo y Aereo" {{ $ver->tipo_alta === 'Maritimo y Aereo' ? 'selected' : '' }}>Marítimo y Aereo</option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="metodo_transmision" id="metodo_transmision" class="form-control" value="{{ $ver->metodo_transmision }}">
                        ...
                        <div class="row">
                          ...
                          <div class="col">
                            <div class="form-group">
                              ...
                              <input type="text" name="dato_vucem_contrasenia" id="dato_vucem_contrasenia" class="form-control" value="{{ $ver->dato_vucem_contrasenia }}">
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="uso_exclusivo_tarifa_maritimo" id="uso_exclusivo_tarifa_maritimo" class="form-control" value="{{ $ver->uso_exclusivo_tarifa_maritimo }}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="uso_exclusivo_referencia_maritimo">Referencia Bancaria (Marítimo):</label>
                                    <input type="text" name="uso_exclusivo_referencia_maritimo" id="uso_exclusivo_referencia_maritimo" class="form-control" value="{{ $ver->uso_exclusivo_referencia_maritimo }}">
                                </div>
                            </div>
                        </div>
                    </div>
